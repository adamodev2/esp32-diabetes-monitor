...
*   **Display Brightness**: Use the 5-100% slider under **Display Settings**, then click **Save Display Settings**. Brightness changes immediately and is restored after reboot.
